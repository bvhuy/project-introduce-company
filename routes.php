...
$route['bai-viet.html'] = 'index.php?module=blog&action=lists';
$route['bai-viet-page-(.+).html'] = 'index.php?module=blog&page=$1';
$route['tim-kiem.html'] = 'index.php?module=search';
$route['tim-kiem.html&page=(.+)'] = 'index.php?module=search&page=$1';
