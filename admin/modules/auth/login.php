 ...
 * http://localhost/online_php/module05/users_manager/?module=users
 * http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=php_online&table=login_token
 */
        ...
        if(!empty($userQuery)) {
            ...
            if(password_verify($password, $passwordHash)) {
                ...
                if(!empty($insertTokenStatus)) {
                    ...
                    //Chuyển hướng qua trang tổng quan
                    redirect('admin');
                } else {
...
<div class="row">
    <div class="col-6" style="margin: 22px auto;">
        ...
        <form action="" method="post">
            ...
            <hr>
            <p class="text-center"><a href="<?php echo _WEB_HOST_ROOT_ADMIN.'?module=auth&action=forgot'; ?>" class="text-decoration-none">Quên mật khẩu</a></p>
        </form>
    </div>
</div>
